...
export class EditarTiposPersonas extends HTMLElement {
    constructor() {
        super();
        this.render()
    }
    async render() {
        const elements = Array.from(await getProducts(`/TiposPersonas`));
        this.innerHTML = /* HTML */`
        <style rel="stylesheet">
            @import "./App/components/Editar/editarTipoPersona/editarTipoPersona.css"; 
        </style>
        <div class="formCard">
        ...
        boton.addEventListener("click", () => {
            ...
            dialog.innerHTML = /* HTML */`
                <div class="formCard-body">
                    <form id="taskForm">
                        <fieldset>
                            <legend style="text-align: center"> Editar Tipos Personas ${idEditar} </legend>
            ...
            form.addEventListener('submit', async (e) => {
                ...
                data.id = idEditar;
                await putProducts("/TiposPersonas", idEditar, data);
                dialog.close();
            });
        });
    }
...
customElements.define("editar-element-tipo-persona", EditarTiposPersonas);