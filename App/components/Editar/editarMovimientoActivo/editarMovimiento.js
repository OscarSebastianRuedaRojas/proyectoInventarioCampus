...
export class EditarTipoDeMovimientos extends HTMLElement {
    constructor() {
        super();
        this.render()
    }
    async render() {
        const elements = Array.from(await getProducts(`/TipoDeMovimientos`));
        this.innerHTML = /* HTML */`
        <style rel="stylesheet">
            @import "./App/components/Editar/editarMovimientos/editarMovimientos.css"; 
        </style>
        <div class="formCard">
            <div class="formCard-body">
                <form id="taskForm"></form>
                <table class="table caption-top">
                <caption>Lista de Tipo De Movimientos</caption>
                <thead>
                  <tr>  
        ...
        boton.addEventListener("click", () => {
            ...
            dialog.innerHTML = /* HTML */`
                <div class="formCard-body">
                    <form id="taskForm">
                        <fieldset>
                            <legend style="text-align: center"> Editar Tipo De Movimientos ${idEditar} </legend>
            ...
            form.addEventListener('submit', async (e) => {
                ...
                data.id = idEditar;
                await putProducts("/TipoDeMovimientos", idEditar, data);
                dialog.close();
            });
        });
    }
...
customElements.define("editar-element-movimiento-activo", EditarTipoDeMovimientos);